...
if __name__ == "__main__":
    ...
    output_dir = './content/drive/'"My Drive"'/CS484-Proj/StackGanv2/output/%s_%s_%s' % \
    ...
    elif cfg.DATA_DIR.find('CelebA') != -1: 
        print(".......")
        dataset = torchvision.datasets.CelebA(root = cfg.DATA_DIR , split='img', target_type='attr', transform=None, target_transform=None, download=False)   
